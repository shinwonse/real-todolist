...
// const KAKAO_AUTHORIZATION_URL = `https://kauth.kakao.com/oauth/authorize?client_id=e6f625075c7051ea84103a3d42dc9a36&redirect_uri=http://localhost:3000/oauth/kakao/redirect&response_type=code`;
